...
LIB_SRC  = src/dnr/mem.d src/dnr/array.d src/dnr/algo.d src/dnr/math.d src/dnr/rng.d src/dnr/testing.d
TEST_SRC = $(LIB_SRC) src/dnr/mem_test.d src/dnr/array_test.d src/dnr/algo_test.d src/dnr/math_test.d src/dnr/rng_test.d src/test_all.d
